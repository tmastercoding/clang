...
void insertEnd(struct Node* head, int data) {
    ...
    // assign prev of newNpde tp temp
    newNode->prev = temp;
}
...
void deleteNode(struct Node* head, struct Node* del_node) {
    ...
    // point the prev of node next to del_node to the
    ...
    // point the next of the previous node to the 
